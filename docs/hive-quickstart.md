...
```sh
hive doctor --state-dir /data/integrated/canary-1311708545-cycle-a --json
hive status --state-dir /data/integrated/canary-1311708545-cycle-a --json
hive pause --state-dir /data/integrated/canary-1311708545-cycle-a --json
hive resume --state-dir /data/integrated/canary-1311708545-cycle-a --json
hive approve-merge --state-dir /data/integrated/canary-1311708545-cycle-a --pr NUMBER --head EXACT_HEAD_SHA --plan --json
hive approve-merge --state-dir /data/integrated/canary-1311708545-cycle-a --pr NUMBER --head EXACT_HEAD_SHA --base EXACT_BASE_SHA --diff-digest EXACT_DIFF_SHA256 --reason "reviewed exact path-held repair" --json
hive revoke-merge-approval --state-dir /data/integrated/canary-1311708545-cycle-a --reason "review withdrawn" --json
hive retry-repair --state-dir /data/integrated/canary-1311708545-cycle-a --finding FINGERPRINT --recurrence N --attempt N --failure-class infrastructure --failure-id FAILURE_ID --reason "dependency restored" --json
```
