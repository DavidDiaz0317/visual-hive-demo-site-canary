...
- .github/workflows/hive-visual-import-smoke.yml: triggers=workflow_dispatch, permissions=contents: read, Visual Hive=yes
- .github/workflows/visual-hive-full-run.yml: triggers=workflow_dispatch, permissions=contents: read, Visual Hive=yes
- .github/workflows/visual-hive-live-detection.yml: triggers=workflow_dispatch, push, permissions=contents: read, Visual Hive=yes
- .github/workflows/visual-hive-production-smoke.yml: triggers=workflow_dispatch, permissions=contents: read, Visual Hive=yes
- .github/workflows/visual-hive-scheduled.yml: triggers=workflow_dispatch, permissions=contents: read, Visual Hive=yes
